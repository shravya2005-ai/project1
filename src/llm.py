...
def _build_structured_answer(question: str, context: str, answer_length: str = "Medium") -> str:
    ...
    if "ripple carry" in context_clean.lower() or "full adder" in context_clean.lower() or "4-bit full adder" in context_clean.lower():
        ...
        if length == "short":
            return "## Definition\nA 4-bit ripple-carry full adder adds two 4-bit numbers by passing the carry from one bit stage to the next.\n\n## Key Points\n- It uses four 1-bit full adders.\n- Carry propagation is the main idea.\n\n## Sources\n- " + sources
        return answer
    ...
    if "product versus process quality management" in context_clean.lower() or "process metrics" in context_clean.lower():
        ...
        if length == "short":
            return "## Definition\nProduct quality checks the final software product, while process quality checks the way the software is produced.\n\n## Key Points\n- Product quality focuses on final output.\n- Process quality focuses on workflow and improvement.\n\n## Sources\n- " + sources
        return answer
